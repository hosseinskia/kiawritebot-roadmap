...
<div class="timeline">
  <div class="timeline-item">
    ...
    <p>Completed weather, translate, news, and more. Ongoing GitHub and siteinfo integrations.</p>
  </div>
  <div class="timeline-item">
    <h3>Phase 2: Security & Performance</h3>
    <p>Implementing JWT, RBAC, and optimizing deployment for speed.</p>
  </div>
  <div class="timeline-item">
    <h3>Phase 3: Analytics & UX</h3>
    <p>Adding real-time dashboards, onboarding tutorials, and dark mode.</p>
  </div>
</div>
